...
vars2Grid = {'time','pressure','temperature','conductivity','altDist','fluorometer','drop','longitude','latitude','chi','chi2','w'};
...
% Rename time fields
time_grid = DataGrid.time;
time_array = DataGrid.time_array;
DataGrid.time = time_array;
DataGrid.time_all = time_grid;
DataGrid = rmfield(DataGrid,'time_array');
