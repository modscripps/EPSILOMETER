...
while 1
   fid=fopen('../STREAMING/epsi_data.bin','r');
    ...
    str=str(ind_madre1(end-11):ind_madre1(end-1));
    ...
    epsi.total_length=unique(diff(ind_epsi))-epsi.finishblock-epsi.name_length-epsi.offset-2;
    ...
    if numel(ind_epsi)==10
        ...
        hold(ax(5),'on')
        l0=loglog(ax(5),f1,squeeze(nanmean(P11(1,:,:),2)),'Color',cmap(4,:));
        l1=loglog(ax(5),f1,squeeze(nanmean(P11(2,:,:),2)),'Color',cmap(5,:));
        l2=loglog(ax(5),f1,squeeze(nanmean(P11(3,:,:),2)),'Color',cmap(6,:));
        l3=loglog(ax(5),f1,squeeze(nanmean(P11(4,:,:),2)),'Color',cmap(7,:));
%         l4=loglog(ax(5),f1,squeeze(nanmean(P11(5,:,:),2)),'Color',cmap(1,:));
        l4=loglog(ax(5),f1,squeeze(nanmean(P11(6,:,:),2)),'Color',cmap(1,:));
        l5=loglog(ax(5),f1,squeeze(nanmean(P11(7,:,:),2)),'Color',cmap(2,:));
        l6=loglog(ax(5),f1,squeeze(nanmean(P11(8,:,:),2)),'Color',cmap(3,:));
