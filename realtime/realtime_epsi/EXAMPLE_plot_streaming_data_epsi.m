...
input_struct.away_dir = '/Users/Shared/EPSI_PROCESSING/Realtime/'; %CHANGE THIS FOR NEW DEPLOYMENT
input_struct.processing_dir = '/Users/Shared/EPSI_PROCESSING/Processing/'; %CHANGE THIS FOR NEW DEPLOYMENT
input_struct.Meta_Data_process_file = ...
    ['/Users/aleboyer/ARNAUD/SCRIPPS/EPSILOMETER/'...
    'Meta_Data_Process/Meta_Data_Process_blt_2022.txt'];

% OPTIONAL INPUTS
input_struct.str_to_match = 'EPSI23'; %CHANGE THIS FOR NEW DEPLOYMENT. (Don't use *, this is going into a strfind)
input_struct.refresh_time_sFCTDec = 5;
%input_struct.version = 4;
input_struct.starting_dnum = datenum(2023,4,26);
