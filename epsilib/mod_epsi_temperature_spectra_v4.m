...
Meta_Data.AFE.t1.cal_profile=dTdV_profile(1,:);
Meta_Data.AFE.t2.cal_profile=dTdV_profile(2,:);
Meta_Data.AFE.t1.ctd_Tmin = nanmin(data_CTD.');
Meta_Data.AFE.t1.ctd_Tmax = nanmax(data_CTD.');
Meta_Data.AFE.t1.pr = nanmean(pr_CTD.');
...
if  plotData
    ...
    loglog(ctd_f,P11_Tctd,'r','linewidth',2)
