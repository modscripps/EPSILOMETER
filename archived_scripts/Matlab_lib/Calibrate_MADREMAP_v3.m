...
plot(ax(1),timeaxis,EPSI.a1,'Color',cmap(1,:))
hold(ax(1),'on')
plot(ax(1),timeaxis,EPSI.a2,'Color',cmap(2,:))
hold(ax(1),'off')

plot(ax(2),timeaxis,EPSI.a3,'Color',cmap(3,:))

plot(ax(3),timeaxis,EPSI.t1,'Color',cmap(4,:))
hold(ax(3),'on')
plot(ax(3),timeaxis,EPSI.t2,'Color',cmap(5,:))
hold(ax(3),'off')

plot(ax(4),timeaxis,EPSI.s1,'Color',cmap(6,:))
hold(ax(4),'on')
plot(ax(4),timeaxis,EPSI.s2,'Color',cmap(7,:))
hold(ax(4),'off')

plot(ax(5),timeaxis(1:end-1),dramp,'Color',cmap(8,:))
...
indscan1=indscan(floor(4*nb_segment/5)-10:floor(4*nb_segment/5)+10);
