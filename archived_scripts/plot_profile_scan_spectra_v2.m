...
%   scanNum - number of scan within the profile
...
for k=scanNum
    ...
    if isfield(scan,'pr') %if there's data in this scan...
        ...
        annotation('textbox',...
            box(4).Position,...
            'String',{datestr(Profile.epsi.dnum(k)),...
...
if saveFig
   figName =  fullfile(Meta_Data.datapath,sprintf('figs/L1_Prof%03.0f_scan%03.0f',Profile.profNum,scanNum));
