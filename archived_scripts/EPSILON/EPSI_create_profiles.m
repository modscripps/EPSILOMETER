function EPSI_create_profiles(Meta_Data,min_depth,crit_depth,ask_for_input)
...
set(gca,'xlim',[CTDProfiles.datadown{1}.ctdtime(1)-0.01,CTDProfiles.datadown{end}.ctdtime(end)+0.01])
