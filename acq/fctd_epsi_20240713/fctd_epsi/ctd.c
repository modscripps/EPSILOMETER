...
Boolean FishCTD_AcquireData(fish_ctd_ptr_t fishCTDPtr)
{
    ...
    switch (fishCTDPtr->CTDPhase)
    {
        ...
        case start_som:   // find a sync = '$'
            ...
            numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
            ...
            }else if(SAN_SETUP_FLAG==FCTD){

                fprintf(stdout, "sbe.start\r\n");
                sprintf(som_cmd,"sbe.start\r\n");
                numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
                ...
                fprintf(stdout, "efe.start\r\n");
                sprintf(som_cmd,"efe.start\r\n");
                numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
                ...
                fprintf(stdout, "alti.start\r\n");
                sprintf(som_cmd,"alti.start\r\n");
                numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
                ...
                fprintf(stdout, "vec.start\r\n");
                sprintf(som_cmd,"vec.start\r\n");
                numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
                ...
                fprintf(stdout, "ttv.start\r\n");
                sprintf(som_cmd,"ttv.start\r\n");
                numBytes = write(fishCTDPtr->SerialPort4CTD.spd, som_cmd, strlen(som_cmd));
...
int CheckCksumData(char *dataStr, int packetSize, int offset)
{
    ...
    {
        printf("Checksums are not match\n");
